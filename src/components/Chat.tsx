...
const ChatComponent = () => {
  ...
  return (
    <>
      {isChatMinimized ? (
        <div
          className="fixed right-5 bottom-5 pb-safe-0 z-50 inline-block cursor-pointer"
          onClick={toggleChat}
        >
        ...
        <div
          className={`border border-gray-200 dark:border-0 bg-gray-50 dark:bg-black w-full fixed left-0 lg:left-auto bottom-0 pb-safe-0 right-0 z-50 flex flex-col lg:right-6 lg:shadow-lg lg:rounded-lg  lg:bottom-6 inline-block lg:w-80 ${
            isChatMinimized ? "minimized" : ""
          }`}
        >
          <div className="border border-gray-200 dark:border-0 bg-gray-50 dark:bg-black w-full fixed left-0 lg:left-auto bottom-0 pb-safe-0 right-0 z-50 flex flex-col lg:right-6 lg:shadow-lg lg:rounded-lg  lg:bottom-6 inline-block lg:w-80">
            ...
            <div className="relative">
              <div
                className="flex-1 overflow-x-hidden overflow-y-auto p-2 scroll-hidden bg-white dark:bg-black overscroll-y-contain relative max-h-72 lg:max-h-96"
