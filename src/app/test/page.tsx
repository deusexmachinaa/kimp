  ...
  return (
    <div className="border border-gray-200 dark:border-0 bg-gray-50 dark:bg-black w-full fixed left-0 lg:left-auto bottom-0 pb-safe-0 right-0 z-50 flex flex-col lg:right-6 lg:shadow-lg lg:rounded-lg  lg:bottom-6 inline-block lg:w-80">
      ...
      <div className="relative">
        ...
        {!isAtBottom && (
          <div className="absolute bottom-8 right-6 text-white dark:text-gray-900 bg-primary shadow cursor-pointer w-12 h-12 rounded-full flex items-center justify-center text-lg transition-opacity pt-0.5 opacity-100 bg-green-500">
            <i
              aria-hidden="true"
